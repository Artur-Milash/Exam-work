...
bool Abstract_handler::handle(std::string str, command_manager::Command* obj) {
	if (this->next) {
...
bool Amount_handler::handle(std::string str, command_manager::Command* obj) {
...
bool Missed_value_handler::handle(std::string str, command_manager::Command* obj) {
	std::size_t size = str.find(",");
...
bool End_handler::handle(std::string str, command_manager::Command* obj) {
	std::size_t size = str.find(",");
